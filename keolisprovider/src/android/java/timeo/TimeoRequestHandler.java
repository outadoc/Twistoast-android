...
import fr.outadev.android.transport.transport.HttpRequester;
import fr.outadev.android.transport.transport.ITransportDataProvider;
...
public class TimeoRequestHandler implements ITransportDataProvider {
    ...
    @Override
    @NonNull
    public List<TimeoLine> getLines(int networkCode) throws XmlPullParserException, IOException, TimeoException {
        String params = "xml=1";
    ...
    @Override
    @Nullable
    public TimeoTrafficAlert getGlobalTrafficAlert(String preHomeUrl) {
        try {
     ...
     */
    private String smartCapitalize(String str) {
        String newStr = "";
