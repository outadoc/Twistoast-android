...
public class TwistoastDatabaseOpenHelper extends SQLiteOpenHelper {
	...
	private static final String STOPS_TABLE_CREATE = "CREATE TABLE twi_stop(stop_id INTEGER, line_id TEXT, dir_id TEXT, stop_name TEXT, PRIMARY KEY(stop_id, line_id, dir_id), FOREIGN KEY(dir_id, line_id) REFERENCES twi_direction(dir_id, line_id));";
