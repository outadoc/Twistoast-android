...
public final class PebbleKit {
	 ...
	 *
	 * @param context      The context used to send the broadcast.
	 * @param watchappUuid A UUID uniquely identifying the target application. UUIDs for the stock kit applications are
	 *                     available in
	 *                     {@link Constants}.
	 * @throws IllegalArgumentException Thrown if the specified UUID is invalid.
	 */
	 ...
	 *                      available in
	 *                      {@link Constants}.
	 * @param data          A dictionary containing one-or-more key-value pairs. For more information about the types of data
	 *                      that
	 *                      can be stored, see {@link PebbleDictionary}.
	...
	public static void sendDataToPebbleWithTransactionId(final Context context,
	                                                     final UUID watchappUuid, final PebbleDictionary data,
	 ...
	 *
	 * @param context       The context used to send the broadcast.
	 * @param transactionId The transaction id of the message in which the data was received. Valid transaction IDs are between
	 *                      (0,
	 *                      255).
	...
	public static abstract class PebbleDataReceiver extends BroadcastReceiver {
		 ...
		 * @param transactionId The transaction ID of the message in which the data was received. This is required when
		 *                      ACK/NACKing
	...
	public static abstract class PebbleAckReceiver extends BroadcastReceiver {
		 ...
		 *
		 * @param context       The BroadcastReceiver's context.
		 * @param transactionId The transaction ID of the message for which the ACK was received. This indicates which message
		 *                      was
	...
	public static abstract class PebbleNackReceiver extends BroadcastReceiver {
		 ...
		 *
		 * @param context       The BroadcastReceiver's context.
		 * @param transactionId The transaction ID of the message for which the NACK was received. This indicates which message
		 *                      was
		 *                      not received.
		 */
	...
	/**
	 * A special-purpose BroadcastReceiver that makes it easy to handle 'DATA_AVAILABLE' data logging intents broadcast from
	 * pebble.apk.
	 */
